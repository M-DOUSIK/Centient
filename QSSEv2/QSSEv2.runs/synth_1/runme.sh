...
HD_PWD='C:/Users/Dousik Manokaran/Downloads/Centient/QSSEv2/QSSEv2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log centient_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source centient_top.tcl
