...
REM
REM Generated by Vivado on Thu Feb 05 00:46:22 +0530 2026
...
echo "xvlog --incr --relax -prj tb_centient_vlog.prj"
call xvlog  --incr --relax -prj tb_centient_vlog.prj -log xvlog.log
