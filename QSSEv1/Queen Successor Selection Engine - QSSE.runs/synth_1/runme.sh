...
HD_PWD='C:/Users/Dousik Manokaran/Downloads/Centient/Queen Successor Selection Engine - QSSE/Queen Successor Selection Engine - QSSE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_nopipe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_nopipe.tcl
