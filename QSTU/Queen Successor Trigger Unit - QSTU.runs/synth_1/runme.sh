...
HD_PWD='C:/Users/Dousik Manokaran/Downloads/Centient/Queen Successor Trigger Unit - QSTU/Queen Successor Trigger Unit - QSTU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log QSTU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source QSTU.tcl
