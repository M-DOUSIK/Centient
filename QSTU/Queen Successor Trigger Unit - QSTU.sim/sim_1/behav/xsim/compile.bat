...
REM
REM Generated by Vivado on Wed Jan 07 19:46:20 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj qstu_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj qstu_tb_vlog.prj -log xvlog.log
