...
HD_PWD='C:/Users/VLSI_LAB/Desktop/qstuV2/qstuV2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log qstu_subsystem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source qstu_subsystem.tcl
