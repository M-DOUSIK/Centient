...
HD_PWD='C:/Users/Dousik Manokaran/Downloads/Centient/Kalman Filter and Fault Detection - KFFD/Kalman Filter and Fault Detection - KFFD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iir_filter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iir_filter.tcl
